...
//    internal var describle = arrayOf("水果大拼盘", "时钟表盘", "坐标系", "事件监听", "多布局RecycleView列表", "通知栏事件监听", "购物车动画", "照相机", "自定义Toast", "倒计时", "动画", "ViewPager", "下载apk", "Retrofit", "圆环百分比", "收益走势图")
...
//        var rcv: RecyclerView = ((findViewById(R.id.rcv) as RecyclerView?)!!)
