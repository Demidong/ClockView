...
public class MainActivity extends Activity {
    RecyclerView rcv ;
    Class[] clazz = {MatrixActivity.class,PieChatActivity.class, ClockActivity.class,CoordinateActivity.class,EventActivity.class,
            ...
            WaveActivity.class,VideoPlayerActivity.class,SelfDefinedActivity.class,FlowLayoutActivity.class,InputEmojiActivity.class};
    String[] describle = {"Matrix","水果大拼盘","时钟表盘","坐标系","事件监听",
            "多布局RecycleView列表","通知栏事件监听","购物车动画","照相机",
    "自定义Toast","倒计时","动画","ViewPager","下载apk","Retrofit","RXJava",
    "圆环百分比","收益走势图","雷达波浪View","视频播放器","SelfDefinedActivity","FlowLayoutActivity","InputEmojiActivity"};
